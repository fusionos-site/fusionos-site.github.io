  ...
  <header class>
    ...
    >
      ...
      <a href="/" class="hidden mr-4 md:block">
        <img src="@/assets/img/logo1.png" class="w-16 xl:w-18" />
      </a>
      <button
        v-on:click="parentRefs.fullpage.api.moveTo(1)"
        class="hidden px-5 py-2 mx-3 text-lg font-semibold text-white rounded-full focus:outline-none xl:text-xl md:block bg-indigo-600   "
      >Home</button>
      <a
